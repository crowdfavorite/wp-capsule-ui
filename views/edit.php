...
?>
<article
	id="post-edit-<?php echo (int) $post->ID; ?>"
	data-post-id="<?php echo (int) $post->ID; ?>"
	<?php post_class('edit clearfix' . ( is_sticky($post->ID) ? ' sticky' : '' )); ?>
>
	<div class="post-date">
	...
	<div class="post-content">
		<div class="status">
			<p>
				<?php esc_html_e('Last Saved', 'capsule'); ?>:
				<span class="post-last-saved"><?php echo esc_html(get_the_modified_date('g:i a')); ?></span>
				<span class="dirty-indicator">&bull;</span>
				<span class="saving-indicator">&hellip;</span>
			</p>
		</div>
		<header>
			<a href="#" class="post-close-link" title="<?php esc_html_e('Close', 'capsule'); ?>">&#59393;</a>
		</header>
